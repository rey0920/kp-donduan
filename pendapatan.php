  ...
  <div id="content">
    ...
    <div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h6 class="mb-0 text-gray-600">Keuangan / <span class="text-gray-700 font-weight-bold">Pendapatan</span></h6>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="d-flex justify-content-between">
                <h6 class="font-weight-bold text-primary mt-3">Transaksi Masuk</h6>
                <button type="button" class="btn btn-success px-3 -py-3 btn-sm" data-toggle="modal" data-target="#myModalTambah"><i class="fa fa-plus"></i> <b>Pemasukan</b></button>
              </div>

            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="transaksiMasuk" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Tanggal</th>
                                ...
                                ?>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <select class="form-control" name="nama_sumber">
                                      <option value="Adaptor">1. Adaptor</option>
                                      <option value="Baterai">2. Baterai</option>
                                      <option value="Instalasi OS">3. Instalasi OS</option>
            ...
            <div class="modal fade" id="laporan-excel">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <!-- Modal body -->
                  <!-- Form laporan -->
                  <form method="GET" action="export/pendapatan/export-pemasukan-excel.php">
                    <div class="modal-body">
                      <div class="form-group">
            ...
            <div class="modal fade" id="laporan-pdf">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <!-- Modal body -->
                  <!-- Form laporan -->
                  <form method="GET" action="export/pendapatan/export-pemasukan-pdf.php">
                    <div class="modal-body">
                      <div class="form-group">
                        <label for="tgl_awal">Tanggal Awal</label>
                        <input type="date" name="tgl_awal" class="form-control" id="tgl_awal" required>
